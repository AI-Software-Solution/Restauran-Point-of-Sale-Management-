  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      ...
      <button
        ...
        className={`flex items-center justify-center font-bold ${
          isActive("/admin_panel") ? "text-[#f5f5f5] bg-[#343434]" : "text-[#ababab]"
        } w-[300px] rounded-[20px]`}
      >
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order" className="absolute right-10 bottom-20">
        <div>
